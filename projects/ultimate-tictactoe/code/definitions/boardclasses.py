...
class GlobalVariables:
    def __init__(self) -> None:
        ...
        self.game_over = True  # break out of the game loop when the game ends
        self.player = None  
        self.bot = None
        self.bot_difficulty = None
        self.turn = 1
        ### For Online mode
        self.state_of_play = None
        self.socket = None
        self.port = None
        self.ip = None 
        self.pseudo = None
        self.prev_turn = None
        self.ip_perso=com.get_ip()
        ### For bot
        self.prev_lb = None
        self.prev_local_row = None
        self.prev_local_col = None
        ###
        ...
        self.lb_state = {'00': 0, '10': 0, '20': 0, '01': 0, '11': 0, '21': 0, '02': 0, '12': 0, '22': 0, 'NoneNone': 0, '33': 0}
